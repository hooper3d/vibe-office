...
- Browser preview links are now assigned into grouped project outputs as a Preview type when agent outputs exist, so the Output Area lookup path is group first, then Tasks / Artifacts / Preview.
