...
- `src/App.tsx` is still about 1485 lines after extracting the right Output Area shell, Agent setup save-state helpers, Project setup/delete helpers, Free Chat selection helpers, Task lifecycle state reducers, Output Area selectors, request submission state helpers, and composer submission intent routing.
...
| Service tests | Good | 35 tests pass. |
